  ...
  return (
    <div className={`${styles.commentsSection} section`}>
      ...
      <div className={styles.commentsContainer}>
        <div className={styles.comment} style={{maxHeight: expandComment && 'min-content'}} id='commentId'>
        <fieldset>
        {showExpand ? <legend align="right"> <span onClick={() => setExpandComment(true)}>more...</span></legend> : ""}
