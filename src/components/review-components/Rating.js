  ...
  return (
    <fieldset className={styles.ratingContainer}>
        ...
        <div className={styles.rating}>
            ...
            onClick={() => {dispatch({type: "click", payload: 1}); ++ratingCount.current; handleRating()}}
            ...
            onClick={() => {dispatch({type: "click", payload: 2}); ++ratingCount.current; handleRating()}}
            ...
            onClick={() => {dispatch({type: "click", payload: 3}); ++ratingCount.current; handleRating()}}
            ...
            onClick={() => {dispatch({type: "click", payload: 4}); ++ratingCount.current; handleRating()}}
            ...
            onClick={() => {dispatch({type: "click", payload: 5}); ++ratingCount.current; handleRating()}}
